...
function ReportController(TransactionsService, AssetService, DividendsService) {
    ...
    vm.dividend.push({ label: 'Maj',    value1: 5839 + 47 + 16 + 55 + 136 + 623 + 540 });
    ...
    vm.data['2019-05'] = {
        ...
        loan: 29378,
        holdings: [
            { asset: AssetService.akelius,            price: 344.50        },
            { asset: AssetService.atlas_copco,        price: 257.60        },
            { asset: AssetService.autoliv,            price: 684.00        },
            { asset: AssetService.axfood,             price: 183.55        },
            { asset: AssetService.bmw,                price: 2255.00 / 3   },
            { asset: AssetService.castellum,          price: 180.45        },
            { asset: AssetService.catena_media,       price: 57.90         },
            { asset: AssetService.dustin,             price: 88.00         },
            { asset: AssetService.handelsbanken,      price: 101.85        },
            { asset: AssetService.husqvarna,          price: 86.10         },
            { asset: AssetService.industrivarden_c,   price: 206.10        },
            { asset: AssetService.indutrade,          price: 289.40        },
            { asset: AssetService.investor_a,         price: 439.60        },
            { asset: AssetService.kungsleden,         price: 74.45         },
            { asset: AssetService.latour,             price: 132.30        },
            { asset: AssetService.lifco,              price: 482.20        },
            { asset: AssetService.nordea,             price: 72.72         },
            { asset: AssetService.np3,                price: 75.30         },
            { asset: AssetService.pfizer,             price: 402.00        },
            { asset: AssetService.sagax,              price: 35.15         },
            { asset: AssetService.sampo,              price: 1283.00 / 3   },
            { asset: AssetService.skanska,            price: 162.00        },
            { asset: AssetService.stora_enso,         price: 112.20        },
            { asset: AssetService.swedbank,           price: 145.15        },
            { asset: AssetService.telia,              price: 40.65         },
            { asset: AssetService.tryg,               price: 12162.00 / 40 },
            { asset: AssetService.xact_hogutdelande,  price: 124.56        }
        ]
    }
